...
//        		String query = days_combobox.getSelectedItem().toString();
 ...
 // pst.executeQuery();
        ...
        finances_button.setFont(new java.awt.Font("Century Gothic", 1, 14)); // NOI18N
        ...
        starimage.setIcon(new javax.swing.ImageIcon(getClass().getResource("StellarAccents.png"))); // NOI18N
        ...
        balancemessege_label.setFont(new java.awt.Font("Century Gothic", 0, 14)); // NOI18N
